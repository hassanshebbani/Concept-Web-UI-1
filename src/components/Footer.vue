...
const leftBase = ref<HTMLDivElement>();
const laptopSVG = ref<SVGAElement>();
const ctaConnect = ref<HTMLDivElement>();
const innovationHighlight = ref<HTMLDivElement>();
const spiritHighlight = ref<HTMLDivElement>();

const animateFooter = () => {
  const footerTl: GSAPTimeline = gsap.timeline({
    defaults: {
      duration: 0.75,
      ease: "power2.inOut",
    },
